...
export default {
    data: () => ({
        bpm:1,
        products: [
            { img: "pr1.png", title: "Sawi", subtitle:"1kg", price:"Rp. 18.000"},
            { img: "pr2.png", title: "Cinnamon Bun", subtitle:"1kg", price:"Rp. 21.000"},
            { img: "pr3.png", title: "Kentang", subtitle:"1kg", price:"Rp. 11.000"},
            { img: "pr4.png", title: "Korma", subtitle:"1kg", price:"Rp. 24.000"},
            { img: "pr5.png", title: "Oreo", subtitle:"270gm", price:"Rp. 8.000"},
            { img: "pr6.png", title: "Pepaya", subtitle:"1kg", price:"Rp. 15.000"},
        ]
    }),
    methods: {
        decrement(){
